...
async def async_setup_entry(
    ...
    powerSwitch = ApSystemsInverterSwitch(config_entry.runtime_data)
    config_entry.runtime_data.slow_coordinator.setPowerSwitchEntity(powerSwitch)
    add_entities([powerSwitch], True)


class ApSystemsInverterSwitch(CoordinatorEntity, ApSystemsEntity, SwitchEntity):
